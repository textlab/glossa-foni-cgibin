...
use lib ('/hf/foni/home/tekstlab/tmp/');
...
$top_text .= "<input type='button' onclick=\"mapper();\" value='Map' /><br />\n";
...
#	print "<strong>$qwerty</strong><br />";
	...
	if($speech_corpus){
	    $source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"window.open('$conf{'htmlRoot'}/html/profile.php?tid=$identifier&corpus=$CORPUS',");
	    $source_line.=sprintf("'mywindow','height=400,width=600,status,scrollbars,resizable');\"><img src='$conf{'htmlRoot'}/html/img/i.gif' alt='i' / border='0'></a> \n&nbsp;</font>\n");
	}
	...
	if ($speech_corpus) {
		...
		$source_line.=sprintf("document.getElementById('movie_frame').src = '$conf{'htmlRoot'}html/expand.php$ex_url&video=1';\">\n");
		$source_line.=sprintf("<img style='border-style:none' src='$conf{'htmlRoot'}html/img/mov.gif'>\n</a> \n&nbsp;</font>");
	    }
	    $source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"document.getElementById('inspector').style.display='block';");
	    $source_line.=sprintf("document.getElementById('movie_frame').src = '$conf{'htmlRoot'}html/expand.php$ex_url&video=0';\">\n");
...
#    my $ord = $m->{'kwic'}->{'match'};
print "\n<script language='javascript'>\nfunction mapper(){\nwindow.open('$conf{'htmlRoot'}/html/map.php?informants=$all_informants&corpus=$CORPUS','mywindow','height=580,width=850,status,scrollbars,resizable');\n}\n</script>";
...
print "\n<script language=\"javascript\">showList($d_files,'".$conf{'query_id'}."','".$lang{'hits_found'}."',$hits,'".$lang{'results_pages'}."','$CORPUS','$max', '$atttype')</script>\n";
