...
Sine Wave designed by <a href="http://www.thenounproject.com/jmpace" target="_blank">Jared Pace</a> from the <a href="http://www.thenounproject.com" target="_blank">Noun Project</a>
</small></div>
EOF
print "</body></html>\n";
