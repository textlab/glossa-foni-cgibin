...
#print "<script>alert(\'" . $conf{'db_name'} ."::" . $conf{'db_host'} . "\');</script>";
...
print "HERE WE ARE-> $base_corpus -> $ROOT -> $CORPUS -> $conf_file<br / >";
...
#	    print "<script>alert('[[" . $identifier . "]]')</script>";
		...
		$source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"document.getElementById('inspector').style.display='block';document.getElementById('movie_frame').src = 'http://www.tekstlab.uio.no/glossa/html/expand.php$ex_url&video=1';\">\n");
		$source_line.=sprintf("<img style='border-style:none' src='http://omilia.uio.no/glossa/html/img/mov.gif'>\n</a> \n&nbsp;</font>");
	    }
		$source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"document.getElementById('inspector').style.display='block';document.getElementById('movie_frame').src = 'http://www.tekstlab.uio.no/glossa/html/expand.php$ex_url&video=0';\">\n");
