...
while (<DATA>) {
    ...
    my $cpos = $sts{'cpos'};
    if ($del) {
	print "<input type='checkbox' name='delete' value='$cpos' />"; #val was $s_id
    }
    my $identifier = $s_id;
...
#	    $source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"document.getElementById('inspector').style.display='block';document.getElementById('movie_frame').src = '" . $conf{'htmlRoot'}  . "html/media3.php$ex_url&video=1';\">\n");
#	    $source_line.=sprintf("<img style='border-style:none' src='" . $conf{'htmlRoot'} . "html/img/mov.gif'>\n</a> \n&nbsp;</font>");
	}
...
#	$source_line.=sprintf("<font size=\"-2\">\n<a href=\"#\" onClick=\"document.getElementById('inspector').style.display='block';document.getElementById('movie_frame').src = '" . $conf{'htmlRoot'}  . "html/media3.php$ex_url&video=0';\">\n");
#	$source_line.=sprintf("<img style='border-style:none' src='" . $conf{'htmlRoot'} . "html/img/sound.gif'>\n</a> \n&nbsp;</font>");
